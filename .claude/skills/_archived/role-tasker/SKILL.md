...
AH 在 main 完成前置作業後，AD 才進模組任務。

## 約束

- **Edit 模組 CLAUDE.md 時只改「當前任務」區塊內容**；「範圍限制」/「慣例」/「待修項」/「上報區」維持原樣不動（#355/#398 教訓 — AT 誤改「範圍限制」段的污染會被 AD 漏還原並 merge 進 main，一次失誤跨兩輪 PR 才顯形）
- 不 commit / push / PR / 開 issue / 跑 build（Bash 在手，需明確排除）
